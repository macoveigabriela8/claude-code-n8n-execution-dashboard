-- Update tool costs calculation in vw_client_roi_summary view
-- This excludes one-time fees (tools with end_date) and adds support for 24months period
-- Run this in Supabase SQL Editor

-- First, drop and recreate the view with updated tool costs calculation
DROP VIEW IF EXISTS public.vw_client_roi_summary;
